...
namespace Pos_System.Services
{
    internal static class PasswordHasher
    {
        ...
        public static bool Verify(string password, string storedValue)
        {
            ...
            return ConstantTimeEquals(storedValue, password) ||
                   ConstantTimeEquals(storedValue, Sha256Hex(password));
        }
        ...
        private static bool VerifyPbkdf2(string password, string storedValue)
        {
            ...
            if (!int.TryParse(parts[2], out int iterations) || iterations < 10000)
            {
                return false;
            }
        ...
        {
            return ConstantTimeEquals(Encoding.UTF8.GetBytes(left), Encoding.UTF8.GetBytes(right));
        }
